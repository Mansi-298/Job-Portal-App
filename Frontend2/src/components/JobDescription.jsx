...
const JobDescription = () => {
    ...
    const applyJobHandler = async () => {
        try {
            const res = await axios.get(`https://job-portal-app-uomk.onrender.com/api/v1/application/apply/${jobId}`, {withCredentials:true});
    ...
    useEffect(() => {
        const fetchSingleJob = async () => {
            try {
                const res = await axios.get(`https://job-portal-app-uomk.onrender.com/api/v1/job/get/${jobId}`, { withCredentials: true });
                if (res.data.success){
